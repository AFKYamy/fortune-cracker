...
export default function FortuneSelectorCard({ name, authors, mode }: FortuneSelectorCardProps) {
    ...
    return (
        <div
            className="fortune__selector__card flex flex-col justify-center items-center px-5 py-3 rounded-[20px] bg-blackSecondary font-[Rajdhani] shadow-lg cursor-pointer transition-all ease-in-out duration-200 select-none hover:shadow-(--gold-glow) hover:bg-darkGold hover:text-neutral-950 md:px-10 md:py-5 md:rounded-[25px] md:min-w-[230px]"
            data-mode={mode}
